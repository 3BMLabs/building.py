...
def POCWoodFrameWall(l,h,startPoint,studheight,studwidth,spacing):
    ...
    for i in range(count):
        obj1.append(Frame.byStartpointEndpoint(Point.translate(startPoint, Vector3(x, 0, studheight)),
                                               Point.translate(startPoint, Vector3(x, 0, h-studheight)),
                                               Rectangle("stud", studwidth, studheight).curve, "stud", 0, BaseTimber))
        x = x + spacing

    obj1.append(Frame.byStartpointEndpoint(startPoint, Point.translate(startPoint,Vector3(l,0,0)),Rectangle("stud", studwidth, studheight).curve.translate(Vector2(studheight/2,0)),"bottomplate", 90, BaseTimber))
    obj1.append(Frame.byStartpointEndpoint(Point.translate(startPoint,Vector3(0,0,h)), Point.translate(startPoint,Vector3(l,0,h)),Rectangle("stud", studwidth, studheight).curve.translate(Vector2(-studheight/2,0)),"topplate", 90, BaseTimber))
    obj1.append(Frame.byStartpointEndpoint(Point.translate(startPoint, Vector3(l-studheight*0.5, 0, studheight)),

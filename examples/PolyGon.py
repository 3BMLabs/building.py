...
class SteelRectangularShape(SteelShape, RectangularShape):
    def __init__(
        ...
        super().__init__(
            ...
            IFC_profile_def=IFC_profile_def,
            width=width,
            height=height,
        )
...
steel_rectangular_shape = SteelRectangularShape(
    "HEA", "Steel Beam", "A steel beam", "IFC_HEA", 200, 100
)
print(vars(steel_rectangular_shape))

r = SteelRectangularShape("test", "name", "desc", "def", 3, 4)

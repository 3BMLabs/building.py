...
class IShapeParallelFlange(Profile):
    def __init__(self, name, height, width, tw, tf, r):
        ...
        self.curve = PolyCurve(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16)
...
class TProfileRounded(Profile):
    ...
    def __init__(self, name, height, width, tw, tf, r, r1, r2, ex, ey):
        ...
        self.curve = PolyCurve(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14)
...
class RectangleHollowSection(Profile):
    def __init__(self, name, height, width, t, r1, r2):
        ...
        self.curve = PolyCurve(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18)
...
class CProfileWithLips(Profile):
    def __init__(self, name, width, height, h1, t, r1, ex):
        ...
        self.curve = PolyCurve(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20)
...
class SigmaProfileWithLipsColdFormed(Profile):
    def __init__(self, name, width, height, t, r1, h1, h2, h3, b2, ex):
        ...
        self.curve = PolyCurve(l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22, l23,
             l24, l25,
             l26, l27, l28)

...
class View:
    ...
    def deserialize(data):
        ...
        view.cutplane = CoordinateSystem.deserialize(data['cutplane']) if data.get('cutplane') else None
...
class Visibility:
    ...
    def deserialize(data):
        ...
        visibility.cutplane = CoordinateSystem.deserialize(data['cutplane']) if data.get('cutplane') else None

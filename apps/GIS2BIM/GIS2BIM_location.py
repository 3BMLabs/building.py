...
__title__ = "GIS2BIM_set_geolocation"
...
from packages.GIS2BIM import GIS2BIM_FreeCAD
from packages.GIS2BIM import GIS2BIM_CRS
from packages.GIS2BIM import GIS2BIM_GUI
...
class GISLocation_Dialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        self.tempFolderName = "C:/TEMP/"

        # Get/set parameters for GIS
        self.lat =
        self.lon =
        self.bboxWidthStart = "500"
        self.bboxHeightStart = "500"
        self.CRS = 28992
        ...
        self.filepathJSSearch = GIS2BIM.DownloadURL(GIS2BIM_FreeCAD.CreateTempFolder(self.tempFolderName),
                                                    self.URLSearch, "map_filesearch.js")
        self.filepathJSUpdate = GIS2BIM.DownloadURL(GIS2BIM_FreeCAD.CreateTempFolder(self.tempFolderName),
    ...
    def onOk(self):
        ...
        if self.CBAerialphoto.isChecked() is True:
            ...
            TMS = GIS2BIM.TMS_WMTSCombinedMapFromLatLonBbox(float(self.lat), float(self.lon),
                                                            float(self.bboxWidth.text()), float(self.bboxHeight.text()),
                                                            17, 256, 0,
                                                            "http://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}.png")
            TMS[0].save(fileLocationTMS)
            ImageMap = GIS2BIM_FreeCAD.ImportImage(fileLocationTMS, float(self.bboxWidth.text()),

...
#Point translate
p1 = Point(0,0,0)
np1 = translate(p1, Vector3(100,200,400))
project.objects.append(np1)


#Line translate
p1 = Point(0,0,0)
p2 = Point(200,200,200)

l1 = Line(p1, p2)
project.objects.append(l1)

nl1 = translate(l1, Vector3(100,100,200))
project.objects.append(nl1)
...
p3 = Point(100,100,0)
p4 = Point(0,100,0)
pc1 = PolyCurve.byPoints([p1,p2,p3,p4])

npc1 = translate(pc1, Vector3(400,100,300))
project.objects.append(npc1)




# class CoordinateSystem:
# ncs1 = CoordinateSystem(Point(200,0,0), )

# npc2 = scale(pc1, Vector3(1,2,1))
# project.objects.append(npc2)

#Cube translate
# ncb2 = translate(c2, Vector3(100,0,0))
# project.objects.append(ncb2)
